自动路由结果：`new-session`。当前会话存在大量无关上下文，且已明确要求隔离执行；文档可读、计划已批准，发现结果无歧义或错误。未创建、打开或发送新会话。

```text
开发目标：按照已批准的需求、技术规格与实施计划，完整实施 example 功能，并保留以下压力内容：中文、English、café、naïve、Δ、🚀、全角标点「交接」，长路径 docs/specs/2026-07-17-example-design.md，以及连续六个反引号 \u0060\u0060\u0060\u0060\u0060\u0060。严格遵循适用规则、TDD、逐任务独立评审和集成后的整体独立评审。
