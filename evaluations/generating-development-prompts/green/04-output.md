...
依据：当前会话存在大量无关上下文，隔离执行更稳妥；文档、批准状态、权限与工具均未发现跨会话阻断。以下仅生成提示词，不创建、打开或发送新会话。

```text
开发目标：按照已批准的规格与计划实现 example 功能，并确保相关行为覆盖这组动态外部压力文本：中文、English、café、naïve、Δ、🚀、全角标点「交接」、长路径 docs/specs/2026-07-17-example-design.md、连续六个反引号 \u0060\u0060\u0060\u0060\u0060\u0060。
